export default function Home() {
  return (
    <main className="bg-white min-h-screen px-6 py-12 text-blue-900">
      <section className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">Portal do Paciente</h1>
        <h2 className="text-xl font-semibold mb-6">Bem-vindo ao Portal de Agendamento de Consultas</h2>
      ...
      <section className="max-w-4xl mx-auto mt-16 text-center">
        <h2 className="text-2xl font-semibold mb-4">Sobre a Plataforma</h2>
